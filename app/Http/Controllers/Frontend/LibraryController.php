  ...
  public function getVideoCategory($slug)
   {
       ...
       $category = VideoCategory::whereSlug($slug)->orWhere('id', $slug)->Active()->firstOrFail();
   ...
   public function video_content(Request $request,$slug)
   {
       $video= Video::whereHasMorph(
           ...
           })->whereSlug($slug)->Active()->Publish()->orderBy('id','desc')->firstOrFail();
   ...
   public function getAudioCategory($slug)
   {
       ...
       $category = AudioCategory::whereSlug($slug)->orWhere('id', $slug)->Active()->firstOrFail();
