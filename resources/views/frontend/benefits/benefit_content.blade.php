                ...
                <div class="contentDetails row m-0">
                    <div class="col-md-6">
                        ...
                        <div class="col-11 socialShare">
                            <a href="https://api.addthis.com/oexchange/0.8/forward/facebook/offer?url={{ route('frontend.benefits.benefit_content', $benefit->slug) }}&ct=1&title={{ $benefit->name }} &pco=tbxnj-1.0"
                                rel="nofollow" target="_blank"><i class="fab fa-facebook facebook"></i></a>
                            <a href="https://api.addthis.com/oexchange/0.8/forward/twitter/offer?url={{ route('frontend.benefits.benefit_content', $benefit->slug) }}&ct=1&title={{ $benefit->name }} &pco=tbxnj-1.0"
                                rel="nofollow" target="_blank"><i class="fab fa-twitter twitter"></i></a>
                            <a href="https://api.addthis.com/oexchange/0.8/forward/whatsapp/offer?url={{ route('frontend.benefits.benefit_content', $benefit->slug) }}&ct=1&title={{ $benefit->name }} &pco=tbxnj-1.0"
                                rel="nofollow" target="_blank"><i class="fab fa-whatsapp whatsapp"></i></a>
                            <a href="https://api.addthis.com/oexchange/0.8/forward/messenger/offer?url={{ route('frontend.benefits.benefit_content', $benefit->slug) }}&ct=1&title={{ $benefit->name }} &pco=tbxnj-1.0"
                                rel="nofollow" target="_blank"><i class="fab fa-facebook-messenger messenger"></i></a>
                            <a href="https://api.addthis.com/oexchange/0.8/forward/gmail/offer?url={{ route('frontend.benefits.benefit_content', $benefit->slug) }}&ct=1&title={{ $benefit->name }} &pco=tbxnj-1.0"
                                rel="nofollow" target="_blank"><i class="fas fa-envelope gmail"></i></a>
                            <a href="https://api.addthis.com/oexchange/0.8/forward/telegram/offer?url={{ route('frontend.benefits.benefit_content', $benefit->slug) }}&ct=1&title={{ $benefit->name }} &pco=tbxnj-1.0"
                                rel="nofollow" target="_blank"><i class="fab fa-telegram-plane telegram"></i></a>
                            <a href="https://api.addthis.com/oexchange/0.8/forward/viber/offer?url={{ route('frontend.benefits.benefit_content', $benefit->slug) }}&ct=1&title={{ $benefit->name }} &pco=tbxnj-1.0"
                                rel="nofollow" target="_blank"><i class="fab fa-viber viber"></i></a>
                            <a href="https://api.addthis.com/oexchange/0.8/forward/lineme/offer?url={{ route('frontend.benefits.benefit_content', $benefit->slug) }}&ct=1&title={{ $benefit->name }} &pco=tbxnj-1.0"
