    ...
    <div class="col-md-3 sideCategories">
      ...
      <div class="categoriesList">
        <div class="allLinks">
          ...
          <h2><a href="{{ route('frontend.library.audio') }}" style="color: var(--main-color);" title="{{ trans('frontend.all') }}">
        ...
        <div class="categoriesListUl">
          <ul>
            <li>
              ...
              <a href="{{ route('frontend.library.lesson.audio') }}" title="{{ trans('frontend.lessons') }}">
            ...
            <li>
                <i class="fas fa-level-down-alt"></i>
                <a href="{{ route('frontend.library.lecture.audio') }}" title="{{ trans('frontend.lectures') }}">
              ...
              <li>
                <i class="fas fa-level-down-alt"></i>
                <a href="{{ route('frontend.library.article.audio') }}" title="{{ trans('frontend.articles') }}">
              ...
              <li>
                <i class="fas fa-level-down-alt"></i>
                <a href="{{ route('frontend.library.speech.audio') }}" title="{{ trans('frontend.speeches') }}">
              ...
              <li>
                <i class="fas fa-level-down-alt"></i>
                <a href="{{ route('frontend.library.benefit.audio') }}" title="{{ trans('frontend.benefits') }}">
        ...
        <div class="categoriesListUl">
            ...
            <ul>
                <i class="fas fa-bars allCa"></i>
                <a class="otherAudio" href="{{ route('frontend.library.another.audio') }}" title="{{ trans('frontend.another-audioes') }}">
            ...
            <div class="card h-100">
              ...
              <div class="card-body">
                ...
                <div class="text-center mt-4">
                  <a href="{{ route('frontend.library.audio.content',$audio->slug) }}" class="btn-card-more" title="{{ trans('frontend.listen') }}">{{ trans('frontend.listen') }}</a>
                </div>
              </div>
            </div>
          </div>
