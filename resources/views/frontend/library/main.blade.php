  ...
  <div class="libraryPage">
    ...
    <div class="row align-items-center libBox">
      <div class="videoSvg text-center col-md-6">
        <div>
          <img src="{{ asset('frontend/img/VideoPage.svg') }}" alt="{{ trans('frontend.video-library') }}" title="{{ trans('frontend.video-library') }}"/>
      ...
      <div class="audioSvg text-center col-md-6">
        ...
        <a href="{{ route('frontend.library.audio') }}" class="d-block main-btns" title="{{ trans('frontend.audio-library') }}">{{ trans('frontend.audio-library') }} </a>
      </div>
    </div>
  </div>
@endsection
