...
@section('content')
    ...
    <section class="newData">
        ...
        <div class="allTabs row m-0 fade-out">
            <div class="tab col-sm-2 col-lg-4 text-center activeTab" data-content=".les">
                <img src="{{ asset('frontend/img/lesseons.webp') }}" loading="lazy" alt="{{ trans('frontend.lessons') }}"
                    title="{{ trans('frontend.lessons') }}" />
                <p>{{ trans('frontend.lessons') }}</p>
            </div>
            <div class="tab col-sm-2 col-lg-4 text-center" data-content=".lec">
                <img src="{{ asset('frontend/img/lecture.webp') }}" loading="lazy" alt="{{ trans('frontend.lectures') }}"
                    title="{{ trans('frontend.lectures') }}" />
                <p>{{ trans('frontend.lectures') }}</p>
            </div>
            <div class="tab col-sm-2 col-lg-4 text-center" data-content=".spe">
                <img src="{{ asset('frontend/img/speeches.webp') }}" loading="lazy" alt="{{ trans('frontend.speeches') }}"
                    title="{{ trans('frontend.speeches') }}" />
                <p>{{ trans('frontend.speeches') }}</p>
            </div>
            <div class="tab col-sm-2 col-lg-4 text-center" data-content=".art">
                <img src="{{ asset('frontend/img/articles.webp') }}" loading="lazy" alt="{{ trans('frontend.articles') }}"
                    title="{{ trans('frontend.articles') }}" />
                <p>{{ trans('frontend.articles') }}</p>
            </div>
            <div class="tab col-sm-2 col-lg-4 text-center" data-content=".boo">
                <img src="{{ asset('frontend/img/bks.webp') }}" loading="lazy" alt="{{ trans('frontend.books') }}"
                    title="{{ trans('frontend.books') }}" />
                <p>{{ trans('frontend.books') }}</p>
            </div>
            <div class="tab col-sm-2 col-lg-4 text-center" data-content=".pic">
                <img src="{{ asset('frontend/img/picture.webp') }}" loading="lazy" alt="{{ trans('frontend.gallery') }}"
                    title="{{ trans('frontend.gallery') }}" />
                <p>{{ trans('frontend.gallery') }}</p>
            </div>
            <div class="tab col-sm-2 col-lg-4 text-center" data-content=".ved">
                <img src="{{ asset('frontend/img/vedios.webp') }}" loading="lazy" alt="{{ trans('frontend.video-library') }}"
                    title="{{ trans('frontend.video-library') }}" />
                <p>{{ trans('frontend.video-library') }} </p>
            </div>
            <div class="tab col-sm-2 col-lg-4 text-center" data-content=".mic">
                <img src="{{ asset('frontend/img/audio.webp') }}" loading="lazy" alt="{{ trans('frontend.audio-library') }}"
    ...
    <section class="newDataContent">
        <!-- lessons Content -->
        <div class="les row row-cols-1 row-cols-md-3 g-4">
            <?php
        ...
        <!-- lectures Content -->
        <div class="lec row row-cols-1 row-cols-md-3 g-4">
            <?php
        ...
        <!-- speaches content -->
        <div class="spe row row-cols-1 row-cols-md-3 g-4">
            <?php
        ...
        <!-- articles content -->
        <div class="art row row-cols-1 row-cols-md-3 g-4">
            <?php
        ...
        <!-- books content -->
        <div class="boo row row-cols-1 row-cols-md-3 g-4">
            <?php
        ...
        <!-- ved content-->
        <div class="ved row row-cols-1 row-cols-md-3 g-4">
            <?php
        ...
        <!-- mic content -->
        <div class="mic row row-cols-1 row-cols-md-3 g-4">
            <?php
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center mt-4">
                                <a href="{{ route('frontend.library.audio.content', $audio->slug) }}"
                                    class="btn-card-more"
